...
void test_dmat2(math::e_arch arch, unsigned seed) {
    ...
    for (int i = 0; i < NUM_REPEATS; i++) {
        ...
        dmat2 m1, m2(r1), m3(r2, r3, r4, r5), m4(dvec2(r6, r7), dvec2(r8, r9));
        ...
        dmat2 m13 = matrix_comp_mult(m1, m3);
    ...
    for (int i = 0; i < NUM_REPEATS; i++) {
        ...
        dmat2 m0 = { { r1, r2 }, { r3, r4 } }, m1(m0), m2 = m0;
    ...
    {   // additional operators
        ...
        dmat2 m0 = { { r1, r2 }, { r3, r4 } }, m1 = { r1, r2, r3, r4 },
        ...
        dmat2 m8 = { r1, r2, r3, r4 }, m9 = m8, m10 = m8, m11 = m8;

        m8 += dmat2{ r5, r6, r7, r8 };
        m9 -= dmat2{ r5, r6, r7, r8 };
        //m10 *= dmat2{ r5, r6, r7, r8 };
        m11 /= dmat2{ r5, r6, r7, r8 };
...
void test_dmat2() {
    ...
    std::cout << "test_dmat2 (seed " << seed << ")" << std::endl;

    test_dmat2(math::Scalar, seed);
#ifndef __arm__
    test_dmat2(math::SSE2, seed);
    test_dmat2(math::SSE3, seed);
    test_dmat2(math::SSE4_1, seed);
    test_dmat2(math::AVX, seed);
#else
    test_dmat2(math::NEON, seed);
#endif
}
