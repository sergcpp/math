...
void test_dmat4(math::e_arch arch, unsigned seed) {
    ...
    for (int i = 0; i < NUM_REPEATS; i++) {
        ...
        dmat4 m1, m2(r1),
              m3(r2, r3, r4, r5,
                 ...
                 r10, r11, r12, r13,
                 r14, r15, r16, r17),
             m4(dvec4{ r18 }, dvec4{ r19 }, dvec4{ r20 }, dvec4{ r21 });
        ...
        m1[0] = dvec4(r22, r23, r24, r25);
        m1[1] = dvec4(r26, r27, r28, r29);
        ...
        dmat4 m13 = matrix_comp_mult(m1, m3);
...
void test_dmat4() {
    ...
    std::cout << "test_dmat4 (seed " << seed << ")" << std::endl;

    test_dmat4(math::Scalar, seed);
#ifndef __arm__
    test_dmat4(math::SSE2, seed);
    test_dmat4(math::SSE3, seed);
    test_dmat4(math::SSE4_1, seed);
    test_dmat4(math::AVX, seed);
#else
    test_dmat4(math::NEON, seed);
#endif
}
