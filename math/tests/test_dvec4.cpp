...
void test_dvec4(math::e_arch arch, unsigned seed) {
	...
	for (int i = 0; i < NUM_REPEATS; i++) {
        ...
        assert(v2[0] == Approx(r1)); assert(v2[1] == Approx(r1)); assert(v2[2] == Approx(r1)); assert(v2[3] == Approx(r1));
		...
		assert(v4[0] == Approx(r6)); assert(v4[1] == Approx(r6)); assert(v4[2] == Approx(r6)); assert(v4[3] == Approx(r6));
		assert(v5[0] == Approx(r6 + r2)); assert(v5[1] == Approx(r6 + r3)); assert(v5[2] == Approx(r6 + r4)); assert(v5[3] == Approx(r6 + r5));

        dvec4 v6 = v1 - v2, v7 = v2 - v3;

		assert(v6[0] == Approx(-r6)); assert(v6[1] == Approx(-r6)); assert(v6[2] == Approx(-r6)); assert(v6[3] == Approx(-r6));
		assert(v7[0] == Approx(r6 - r2)); assert(v7[1] == Approx(r6 - r3)); assert(v7[2] == Approx(r6 - r4)); assert(v7[3] == Approx(r6 - r5));

        dvec4 v8 = v1 * v2, v9 = v2 * v3;

		assert(v8[0] == Approx(0)); assert(v8[1] == Approx(0)); assert(v8[2] == Approx(0)); assert(v8[3] == Approx(0));
		assert(v9[0] == Approx(r6 * r2)); assert(v9[1] == Approx(r6 * r3)); assert(v9[2] == Approx(r6 * r4)); assert(v9[3] == Approx(r6 * r5));

        dvec4 v10 = v1 / v2, v11 = v2 / v3;

		assert(v10[0] == Approx(0)); assert(v10[1] == Approx(0)); assert(v10[2] == Approx(0)); assert(v10[3] == Approx(0));
		assert(v11[0] == Approx(r6 / r2)); assert(v11[1] == Approx(r6 / r3)); assert(v11[2] == Approx(r6 / r4)); assert(v11[3] == Approx(r6 / r5));
    }
	...
	for (int i = 0; i < NUM_REPEATS; i++) {
		...
		assert(v3 == Approx4(r1, r2, r3, r4)); assert(v4 == Approx4(r1, r2, r8, r9));
		assert(v5 == Approx4(r10, r1, r2, r11)); assert(v6 == Approx4(r12, r13, r3, r4));
		assert(v7 == Approx4(r5, r6, r7, r14)); assert(v8 == Approx4(r15, r5, r6, r7));
		assert(v9 == Approx4(r1, r2, r3, r4)); assert(v10 == Approx4(r1, r2, r3, r4));
    }
	...
	for (int i = 0; i < NUM_REPEATS; i++) {
		...
		assert(v0 == Approx4(r1 + 1, r2 + 1, r3 + 1, r4 + 1)); assert(v1 == Approx4(r1 + 1, r2 + 1, r3 + 1, r4 + 1));
		assert(v4 == Approx4(r1, r2, r3, r4)); assert(v5 == Approx4(r1 + 1, r2 + 1, r3 + 1, r4 + 1));

		dvec4 v6 = v2--, v7 = --v3;

		assert(v2 == Approx4(r5 - 1, r6 - 1, r7 - 1, r8 - 1)); assert(v3 == Approx4(r5 - 1, r6 - 1, r7 - 1, r8 - 1));
		assert(v6 == Approx4(r5, r6, r7, r8)); assert(v7 == Approx4(r5 - 1, r6 - 1, r7 - 1, r8 - 1));
		...
		assert(v8 == Approx4(r9 + r13, r10 + r14, r11 + r15, r12 + r16)); assert(v9 == Approx4(r9 - r13, r10 - r14, r11 - r15, r12 - r16));
		assert(v10 == Approx4(r9 * r13, r10 * r14, r11 * r15, r12 * r16)); assert(v11 == Approx4(r9 / r13, r10 / r14, r11 / r15, r12 / r16));
