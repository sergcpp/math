...
void test_mat4(math::e_arch arch, unsigned seed) {
    ...
    for (int i = 0; i < NUM_REPEATS; i++) {
        ...
        require(m1[0] == Approx4(1, 0, 0, 0));
        require(m1[1] == Approx4(0, 1, 0, 0));
        require(m1[2] == Approx4(0, 0, 1, 0));
        require(m1[3] == Approx4(0, 0, 0, 1));

        require(m2[0] == Approx4(r1, 0, 0, 0));
        require(m2[1] == Approx4(0, r1, 0, 0));
        require(m2[2] == Approx4(0, 0, r1, 0));
        require(m2[3] == Approx4(0, 0, 0, r1));

        require(m3[0] == Approx4(r2, r3, r4, r5));
        require(m3[1] == Approx4(r6, r7, r8, r9));
        require(m3[2] == Approx4(r10, r11, r12, r13));
        require(m3[3] == Approx4(r14, r15, r16, r17));

        require(m4[0] == Approx4(r18, r18, r18, r18));
        require(m4[1] == Approx4(r19, r19, r19, r19));
        require(m4[2] == Approx4(r20, r20, r20, r20));
        require(m4[3] == Approx4(r21, r21, r21, r21));

        m1[0] = vec4(r22, r23, r24, r25);
        m1[1] = vec4(r26, r27, r28, r29);

        require(m1[0] == Approx4(r22, r23, r24, r25));
        require(m1[1] == Approx4(r26, r27, r28, r29));
        require(m1[2] == Approx4(0, 0, 1, 0));
        require(m1[3] == Approx4(0, 0, 0, 1));
        ...
        require(m1[0] == Approx4(r22, r30, r24, r25));
        require(m1[1] == Approx4(r26, r31, r28, r29));
        require(m1[2] == Approx4(0, 0, 1, 0));
        require(m1[3] == Approx4(0, 0, 0, 1));

        mat4 m5 = m1 + m2, m6 = m2 + m3;

        require(m5[0] == Approx4(r22 + r1, r30, r24, r25) &&
               m5[1] == Approx4(r26, r31 + r1, r28, r29) &&
               m5[2] == Approx4(0, 0, 1 + r1, 0) &&
               m5[3] == Approx4(0, 0, 0, 1 + r1));
        require(m6[0] == Approx4(r1 + r2, r3, r4, r5) &&
        ...
        require(m11[0] == Approx4(r1 / r22, 0, 0, 0) &&
        ...
        require(m13[0] == Approx4(r22 * r2, r30 * r3, r24 * r4, r25 * r5) &&
        ...
        require(m14[0] == Approx4(r38 * r22, r38 * r30, r38 * r24, r38 * r25));
        require(m14[1] == Approx4(r38 * r26, r38 * r31, r38 * r28, r38 * r29));
        require(m14[2] == Approx4(r38 * r30, r38 * r31, r38 * r32, r38 * r33));
        require(m14[3] == Approx4(r38 * r34, r38 * r35, r38 * r36, r38 * r37));

        require(m15[0] == Approx4(r38 * r22, r38 * r30, r38 * r24, r38 * r25));
        require(m15[1] == Approx4(r38 * r26, r38 * r31, r38 * r28, r38 * r29));
        require(m15[2] == Approx4(r38 * r30, r38 * r31, r38 * r32, r38 * r33));
        require(m15[3] == Approx4(r38 * r34, r38 * r35, r38 * r36, r38 * r37));

        require(m16[0] == Approx4(r22 / r38, r30 / r38, r24 / r38, r25 / r38));
        require(m16[1] == Approx4(r26 / r38, r31 / r38, r28 / r38, r29 / r38));
        require(m16[2] == Approx4(r30 / r38, r31 / r38, r32 / r38, r33 / r38));
        require(m16[3] == Approx4(r34 / r38, r35 / r38, r36 / r38, r37 / r38));
    }

    {
        ...
        for (size_t i = 0; i < mat4_mul_mat4_test_data.size(); i += 48) {
            ...
            require(m3[0] == Approx4(mat4_mul_mat4_test_data[i + 32], mat4_mul_mat4_test_data[i + 33], mat4_mul_mat4_test_data[i + 34], mat4_mul_mat4_test_data[i + 35]));
            require(m3[1] == Approx4(mat4_mul_mat4_test_data[i + 36], mat4_mul_mat4_test_data[i + 37], mat4_mul_mat4_test_data[i + 38], mat4_mul_mat4_test_data[i + 39]));
            require(m3[2] == Approx4(mat4_mul_mat4_test_data[i + 40], mat4_mul_mat4_test_data[i + 41], mat4_mul_mat4_test_data[i + 42], mat4_mul_mat4_test_data[i + 43]));
            require(m3[3] == Approx4(mat4_mul_mat4_test_data[i + 44], mat4_mul_mat4_test_data[i + 45], mat4_mul_mat4_test_data[i + 46], mat4_mul_mat4_test_data[i + 47]));

            mat4 m4 = m1;
            m4 *= m2;

            require(m4[0] == Approx4(mat4_mul_mat4_test_data[i + 32], mat4_mul_mat4_test_data[i + 33], mat4_mul_mat4_test_data[i + 34], mat4_mul_mat4_test_data[i + 35]));
            require(m4[1] == Approx4(mat4_mul_mat4_test_data[i + 36], mat4_mul_mat4_test_data[i + 37], mat4_mul_mat4_test_data[i + 38], mat4_mul_mat4_test_data[i + 39]));
            require(m4[2] == Approx4(mat4_mul_mat4_test_data[i + 40], mat4_mul_mat4_test_data[i + 41], mat4_mul_mat4_test_data[i + 42], mat4_mul_mat4_test_data[i + 43]));
            require(m4[3] == Approx4(mat4_mul_mat4_test_data[i + 44], mat4_mul_mat4_test_data[i + 45], mat4_mul_mat4_test_data[i + 46], mat4_mul_mat4_test_data[i + 47]));
        }
    }
    ...
    for (int i = 0; i < NUM_REPEATS; i++) {
        ...
        require(m12[0] == Approx4(-r33, -r34, -r35, -r36) &&
        ...
        require(m14[0] == Approx4(r33 + 1, r34 + 1, r35 + 1, r36 + 1) &&
