...
void test_vec3(math::e_arch arch, unsigned seed) {
    ...
    for (int i = 0; i < NUM_REPEATS; i++) {
        ...
        assert(v2[0] == Approx(r5));
        assert(v2[1] == Approx(r5));
        assert(v2[2] == Approx(r5));
        ...
        assert(v4[0] == Approx(r5));
        assert(v4[1] == Approx(r5));
        assert(v4[2] == Approx(r5));
        assert(v5[0] == Approx(r5 + r2));
        assert(v5[1] == Approx(r5 + r3));
        assert(v5[2] == Approx(r5 + r4));

        vec3 v6 = v1 - v2, v7 = v2 - v3;

        assert(v6[0] == Approx(-r5));
        assert(v6[1] == Approx(-r5));
        assert(v6[2] == Approx(-r5));
        assert(v7[0] == Approx(r5 - r2));
        assert(v7[1] == Approx(r5 - r3));
        assert(v7[2] == Approx(r5 - r4));
        ...
        assert(v9[0] == Approx(r5 * r2));
        assert(v9[1] == Approx(r5 * r3));
        assert(v9[2] == Approx(r5 * r4));
        ...
        assert(v11[0] == Approx(r5 / r2));
        assert(v11[1] == Approx(r5 / r3));
        assert(v11[2] == Approx(r5 / r4));
    }
    ...
    for (int i = 0; i < NUM_REPEATS; i++) {
        ...
        assert(v1 == Approx3(r1, r2, r3));
        assert(v2 == Approx3(r4, r1, r2));
        assert(v3 == Approx3(r4, r1, r2));
        assert(v4 == Approx3(r4, r1, r2));
    }
    ...
    for (int i = 0; i < NUM_REPEATS; i++) {
        ...
        assert(v0 == Approx3(r1 + 1, r2 + 1, r3 + 1));
        assert(v1 == Approx3(r1 + 1, r2 + 1, r3 + 1));
        assert(v4 == Approx3(r1, r2, r3));
        assert(v5 == Approx3(r1 + 1, r2 + 1, r3 + 1));

        vec3 v6 = v2--, v7 = --v3;

        assert(v2 == Approx3(r4 - 1, r5 - 1, r6 - 1));
        assert(v3 == Approx3(r4 - 1, r5 - 1, r6 - 1));
        assert(v6 == Approx3(r4, r5, r6));
        assert(v7 == Approx3(r4 - 1, r5 - 1, r6 - 1));
        ...
        assert(v8 == Approx3(r1 + r4, r2 + r5, r3 + r6));
        assert(v9 == Approx3(r1 - r4, r2 - r5, r3 - r6));
        assert(v10 == Approx3(r1 * r4, r2 * r5, r3 * r6));
        assert(v11 == Approx3(r1 / r4, r2 / r5, r3 / r6));
