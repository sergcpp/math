...
void test_ivec4(math::e_arch arch) {
...

    {
        ...
        assert(v3 == ivec4(0, 1, 2, 3));
        assert(v4 == ivec4(0, 1, 5, 6));
        assert(v5 == ivec4(4, 0, 1, 6));
        assert(v6 == ivec4(5, 7, 2, 3));
...

    {
        ...
        assert(v0 == ivec4(2, 3, 4, 5));
        assert(v1 == ivec4(2, 3, 4, 5));
        assert(v4 == ivec4(1, 2, 3, 4));
        assert(v5 == ivec4(2, 3, 4, 5));

        ivec4 v6 = v2--, v7 = --v3;

        assert(v2 == ivec4(3, 2, 7, 4));
        assert(v3 == ivec4(3, 2, 7, 4));
        assert(v6 == ivec4(4, 3, 8, 5));
        assert(v7 == ivec4(3, 2, 7, 4));
        ...
        assert(v8 == ivec4(2, 4, 6, 8));
        assert(v9 == ivec4(0, 0, 0, 0));
        assert(v10 == ivec4(1, 4, 9, 16));
        assert(v11 == ivec4(1, 1, 1, 1));
