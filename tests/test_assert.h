...
inline ApproxT<double> Approx(double x) {
    return ApproxT<double>(x);
}
inline ApproxT<math::dvec2> Approx(const math::vec2 &v) {
    return ApproxT<math::dvec2>(math::dvec2(v));
}
inline ApproxT<math::dvec3> Approx(const math::vec3 &v) {
    return ApproxT<math::dvec3>(math::dvec3(v));
}
inline ApproxT<math::dvec4> Approx(const math::vec4 &v) {
    return ApproxT<math::dvec4>(math::dvec4(v));
}
inline ApproxT<math::dvec2> Approx2(double x, double y) {
    return ApproxT<math::dvec2>({ x, y });
}
inline ApproxT<math::dvec3> Approx3(double x, double y, double z) {
    return ApproxT<math::dvec3>({ x, y, z });
}
inline ApproxT<math::dvec4> Approx4(double x, double y, double z, double w) {
    return ApproxT<math::dvec4>({ x, y, z, w });
}
